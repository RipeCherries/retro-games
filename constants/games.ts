export const games = [
  {
    ...
    description:
      'Super Mario Advance — это переиздание классической игры из серии Super Mario, ' +
  ...
  },
  {
    ...
    slug: 'shantae',
    description:
      'Shantae — это приключенческая платформенная игра, выпущенная для Game Boy Color ' +
  ...
  },
  {
    ...
    slug: 'aladdin',
    description:
      'Aladdin для Super Nintendo Entertainment System (SNES) — это классическая ' +
  ...
  },
  {
    ...
    description:
      'Super Smash Bros — это культовый файтинг, выпущенный в 1999 году компанией Nintendo. ' +
  ...
  },
  {
    ...
    description:
      'Sonic the Hedgehog — это 2D-платформер, выпущенный в 1991 году. ' +
  ...
  },
  {
    ...
    slug: 'comix-zone',
    description:
      'Comix Zone — это уникальный 2D-битемап, выпущенный в 1995 году, ' +
  ...
  },
  {
    ...
    slug: 'battletoads',
    description:
      'Battletoads — это порт легендарной игры, впервые выпущенной в 1991 году для NES. ' +
